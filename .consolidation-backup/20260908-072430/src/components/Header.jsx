            ...
            <>
              {user.role === "seller" && (
                <Button
                  ...
                  className="bg-white/10 text-white hover:bg-white/20 rounded-xl px-4 flex items-center gap-1.5 border border-white/20"
                >
                  <LayoutDashboard className="w-4 h-4" />
                  Dashboard
                </Button>
              )}
              <div className="hidden sm:flex items-center gap-2 text-white/90 bg-white/5 px-3 py-1.5 rounded-xl border border-white/10">
