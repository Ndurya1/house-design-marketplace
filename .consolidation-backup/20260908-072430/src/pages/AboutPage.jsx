    ...
    <div className="flex flex-col min-h-screen bg-slate-50 font-sans antialiased text-slate-800 animate-in fade-in duration-700">
      ...
      <section className="relative pt-32 pb-24 px-6 overflow-hidden bg-slate-900 border-b border-slate-800">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <span className="inline-flex items-center gap-1.5 px-3 py-1 text-xs font-semibold tracking-wider text-blue-400 bg-blue-500/10 rounded-full uppercase mb-6 border border-blue-500/20">
          ...
          <div className="space-y-6 text-lg md:text-xl text-slate-300 font-light leading-relaxed max-w-3xl mx-auto">
            <p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch">
          ...
          <div className="bg-white border border-slate-200/80 rounded-2xl p-8 md:p-12 shadow-xl shadow-slate-100/50 flex flex-col justify-between hover:border-slate-300 transition-all duration-300">
            ...
            <div className="mt-8 pt-6 border-t border-slate-100 flex items-center gap-3">
              <span className="font-display font-semibold text-amber-700 bg-amber-50 px-3 py-1 rounded-full text-xs">
                The Friction Point
              </span>
              <p className="font-semibold text-slate-900 text-sm">The problem isn't talent. It's infrastructure.</p>
            </div>
          </div>
      ...
      <section className="py-24 bg-slate-900 text-white px-6 relative overflow-hidden border-t border-slate-800">
        ...
        <div className="absolute inset-0 z-0 opacity-5 bg-[linear-gradient(to_right,#808080_1px,transparent_1px),linear-gradient(to_bottom,#808080_1px,transparent_1px)] bg-[size:32px_32px]"></div>

        <div className="relative z-10 max-w-7xl mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-20">
            <span className="text-xs font-semibold text-blue-400 bg-blue-500/10 px-3 py-1 rounded-full uppercase tracking-wider border border-blue-500/20">
              Why Choose PlanSoko
            </span>
