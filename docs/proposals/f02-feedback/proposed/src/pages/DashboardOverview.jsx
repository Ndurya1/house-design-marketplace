  ...
  return (
    <div className=" min-h-screen flex   bg-slate-50 font-sans">
      ...
      <main className="flex-1 pt-6 pb-16 px-8    md:ml-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          ...
          <Card className=" bg-white overflow-hidden  relative">
            <CardContent className="p-6 flex items-center justify-between">
              <div>
                 <h3 className="text-3xl font-black text-slate-800 mt-1">{loadingPlans ? '…' : plansError ? 'Unavailable' : plans.length}</h3>
        ...
        {activeTab === 'designs' && (
          <div>
            <h2 ref={designsFocusRef} tabIndex={-1} className="ui-section-title mb-4 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary">My Designs</h2>
            {loadingPlans ? (
