...
export default function ErrorPage(){
    ...
    return(
        ...
        <div className="flex flex-col items-center justify-center min-h-screen ">
            ...
            <p className=" font-semibold tracking-wide items-center justify-center text-center"> Oops! looks like you got lost. We couldn't find this page<br/> <span className="text-xs font-normal text-black/70">Maybe you should go back to where you started</span></p>
