...
export default function BrowsePage() {
  ...
  return <BrowseContent key={JSON.stringify([routeCategory, query])} routeCategory={routeCategory}
    searchParams={searchParams} setSearchParams={setSearchParams} query={query} />;
}

function BrowseContent({ routeCategory, searchParams, setSearchParams, query }) {
